...
// const file = "wi-day-cloudy-gusts-t4.svg";
// // const fPath=`../../images/test/${file}`.toString()
// const fPath = "../../images/test/wi-day-cloudy-gusts-t4.svg";
// import svgTest from "../../images/test/wi-day-cloudy-gusts-t4.svg";
// const func1=async()=>{

//   const picture = await import { ReactComponent as ReactLogo } from "../../images/test/wi-day-cloudy-gusts-t4.svg";
// }
// const picture = (await import(`../path/to/file/${this.props.picPath}`))
...
const WeatherOfDay = ({ dayWeather: { day, date, low, high, text, code } }) => {
  ...
  return (
    <div className=" card col-5 col-lg-3 m-2 WeatherOfDay-div-card ">
      ...
      {/* <ReactLogo /> */}
      {/* <svg
        // xmlns="../../images/test/1652344602bee.svg"
